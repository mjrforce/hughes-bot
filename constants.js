...
exports.SF_ORGID = process.env.SF_ORGID;
exports.SF_BUTTONID = process.env.SF_BUTTONID;
exports.SF_ENDPOINT = process.env.SF_ENDPOINT;
exports.SF_CLIENT_ID = process.env.SF_CLIENT_ID;
exports.SF_CLIENT_SECRET = process.env.SF_CLIENT_SECRET;
exports.HEROKU_URL = process.env.HEROKU_URL;
exports.SF_DEPLOYMENTID = process.env.SF_DEPLOYMENTID;
